...
<!-- SOHAM: Add your narrative introduction here (2-3 sentences setting up what the reader is about to see) -->

<!-- SOHAM: Paste your data loading chunk below. Use this header format:
```{r}
#| label: load-soham-data
#| include: false

# Primary Author: Soham | Reviewed by: [Member Name]
...
<!-- SOHAM: Paste your visualization chunks below, one per figure, each with:
- #| label: fig-soham-1 (increment for each figure)
- #| fig-cap: "..."
- #| fig-alt: "..."
- Primary Author / Reviewed by comment
-->

<!-- SOHAM: After each figure, write your narrative observation in your own words.
