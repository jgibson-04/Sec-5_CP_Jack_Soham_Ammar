...
# Primary Author: Jack | Reviewed by: [Member Name]
# Plan: [describe what you are loading and why]
# Source file: [your R script filename]

# your code here
```
-->

<!-- JACK: Paste your visualization chunks below, one per figure, each with:
- #| label: fig-jack-1 (increment for each figure)
- #| fig-cap: "..."
- #| fig-alt: "..."
- Primary Author / Reviewed by comment
-->

<!-- JACK: After each figure, write your narrative observation in your own words.
Start with what you observe from the graph, then explain what it means. -->
